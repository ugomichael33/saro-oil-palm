...
function Footer() {
  return (
    <div className='mx-auto' style={{height:'350px', backgroundColor:'#f4f4f4'}}>
        <div className='footer__logo'>
            <div className='flex ml-2'>
                <ViewKanbanIcon />
                <h2 className='font-bold text-xl font-sans ml-1' style={{color:'#323232',lineHeight:'27px'}}>Saro oil Palm</h2>
            </div>
            <p className='text-base ml-2 font-sans' style={{color:'#969696', lineHeight:'29px'}}>Learn about us and how we can help you with<br/> 
