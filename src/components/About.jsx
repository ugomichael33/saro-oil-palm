    ...
    <div className='about flex flex-col w-full mx-auto lg:flex' style={{background:'#F4F4F4', height:'900px'}} id='aboutus'>
      <div className='lg:flex'>
        <div className='lg:w-1/4 lg:ml-16 lg:mt-32'>
            ...
            <p className='ml-2 text-base font-sans lg:mt-4' style={{color:'#969696', lineHeight:'29px'}}>Saro Oil Palm, still a project under Saro Africa
               International is currently being supervised by the
               Saroafrica Board.
            </p>
            <button className='rounded-lg text-white font-semibold px-5 py-2 shadow-lg  mt-5 ml-2 animate-bounce bg-[#145A2F] lg:bg-[#E2963C] lg:px-10 lg:py-4 lg:mt-20'>View Our Management Team</button>
        </div>

        <div className='about-main flex mt-32 ml-20'>
            <img className ='ml-20 mt-16 w-[470px] h-[540px]' src={headquaters} alt='' />
